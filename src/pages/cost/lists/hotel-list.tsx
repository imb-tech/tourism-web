...
function CostItem({ day, data }: CostGeneratedItem) {
    ...
    return (
        <CustomTable grid="grid-cols-9" className="py-2">
            <div className="flex flex-col justify-center">
                <p className="text-primary">Day {day}</p>
            </div>
            <form className="flex flex-col col-span-8 gap-1">
                {fields?.map((col, i) => (
                    <div
                        className={cn(
                        ...
                        key={col.key}
                    >
                        <CustomTableCol>{data[i].hotel_name}</CustomTableCol>
                        <CustomTableCol>{data[i].room_name}</CustomTableCol>
                        <CustomTableCol>{data[i].count}</CustomTableCol>
                        <CustomTableCol>
